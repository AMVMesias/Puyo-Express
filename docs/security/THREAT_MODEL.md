...
| Escalada de rol desde registro | Backend fuerza el rol cliente en registro público |
...
4. **Autorización por propiedad:** clientes quedan filtrados por su identidad, pero el modelo todavía no vincula de forma inequívoca cada cuenta restaurante/repartidor con una única entidad. Debe reforzarse antes de operar con múltiples organizaciones no confiables.
...
12. **Clave de Google Maps:** es visible en el navegador por diseño y debe restringirse por dominio y APIs desde Google Cloud.
